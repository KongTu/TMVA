...
TFile* file = new TFile("~/2014Research/ROOT_file/V0reco.root");
TTree* theTree = (TTree*)file->Get("ana/v0_Kshort");

TCanvas* s1 = new TCanvas("s1","test",600,800);

theTree->Draw("ks_mass>>myHist","TMath::Abs(ks_dau1_dzos) > 1 & TMath::Abs(ks_dau2_dzos)>1 & TMath::Abs(ks_dau1_dxyos)>1 & TMath::Abs(ks_dau2_dxyos)>1 & ks_dau1_nhit > 3 & ks_dau2_nhit >3 & ks_agl > 0.999 & ks_dlos > 5");
